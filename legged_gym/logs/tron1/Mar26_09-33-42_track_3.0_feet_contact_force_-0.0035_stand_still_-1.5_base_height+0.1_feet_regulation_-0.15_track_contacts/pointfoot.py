...
class PointFoot:
    ...
    def _compose_proprioceptive_obs_buf_no_height_measure(self):
        ...
        # print(self.proprioceptive_obs_buf.cpu().detach().numpy())
    ...
    def _reward_feet_air_time(self):
        ...
        self.feet_air_time += self.dt
        rew_airTime = torch.sum((self.feet_air_time - 0.08) * first_contact, dim=1) # reward only on first contact with the ground
    ...
    def _reward_feet_swing_height(self):
        ...
        pos_error = torch.square(self.foot_positions[:, :, 2] - self.cfg.rewards.feet_height_target) * ~contact
        # print(pos_error)
